...
navbar.insertAdjacentHTML("beforeend",
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="../index.html"><img src="../src/Future Team México.png" alt="" width="150px" height="120px"
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown" style="text-aling:center;">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="https://fmj2024.github.io/Voluntarios/formproyectos.html" style="margin-right: 50px;">Proyectos, líderes e
                            iniciativas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://fmj2024.github.io/Voluntarios/formredes.html" style="margin-right: 50px;">Programa voluntariado</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://fmj2024.github.io/NetworEsp/" style="margin-right: 50px;">Patrocinadores</a>
                    </li>
